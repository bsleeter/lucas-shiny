...
# Carbon Stocks Page
    ...
    output$hover_info <- renderUI({
        ...
        point <- nearPoints(selectData1(), hover, threshold = 50, maxpoints = 1, addDist = TRUE)
        ...
        wellPanel(
            ...
            p(HTML(paste0(
                ...
                "<b> Mean Carbon (MMT): </b>", point$Mean, "<br/>",
                "<b> Lower Bound (MMT): </b>", point$Lower, "<br/>",
                "<b> Upper Bound (MMT): </b>", point$Upper, "<br/>",
